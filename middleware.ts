...
const ROLE_ROUTES: Record<string, string[]> = {
    // Admin-only routes
    admin: ['/users', '/utilities', '/api/import'],
    // Admin + Manager routes
    manager: ['/reports', '/clients', '/contacts'],
    // All authenticated users
    inspector: ['/orders', '/routes', '/support', '/resources', '/custom-forms'],
};
...
const PUBLIC_ROUTES = ['/login', '/api/auth', '/client-portal'];
